...
-- ----------------------------
--  Table structure for `yascmf_media`
-- ----------------------------
DROP TABLE IF EXISTS `yascmf_media`;
CREATE TABLE `yascmf_media` (
  `media_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '//头上的信息',
  `media_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `media_url` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `media_pid` int(20) DEFAULT '0',
  `media_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`media_id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=latin1;

-- ----------------------------
--  Records of `yascmf_media`
-- ----------------------------
BEGIN;
INSERT INTO `yascmf_media` VALUES ('1', '手机简评', 'http://www.zealer.work/media/1', '0', null), ('2', '硬件测评', 'http://www.zealer.work/media/2', '0', null), ('3', 'ZEALER | TIPS', 'http://www.zealer.work/media/3', '0', null), ('4', 'ZEALER 酷品', 'http://www.zealer.work/media/4', '0', null), ('5', '智慧生活', 'http://www.zealer.work/media/5', '1', null), ('6', '科技相对论', 'http://www.zealer.work/media/6', '1', null), ('7', 'UPPER', 'http://www.zealer.work/media/7', '1', null), ('8', '行业报道', 'http://www.zealer.work/media/8', '1', null), ('9', 'ZEALER 那些事', 'http://www.zealer.work/media/9', '1', null), ('10', '全部', 'http://www.zealer.work/media/10', '1', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yascmf_metas` VALUES ('1', '默认', null, 'default', 'category', '默认7', '0', '0'), ('2', '软件', null, 'soft', 'category', '收录个人开发的软件或脚本', '0', '0'), ('3', '文档', null, 'docs', 'category', '这里收录自己开发过程中所撰写的文档', '0', '0'), ('4', 'Laravel', null, 'laravel', 'category', '分享一些Laravel相关文章', '0', '0'), ('5', 'Javascript', null, 'javascript', 'category', '前端Javascript相关知识', '0', '0'), ('6', '测试', null, null, 'category', '测试内容', '0', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yascmf_permissions` VALUES ('1', 'manage_contents', '管理内容', null, '2014-12-22 02:30:59', '2014-12-22 02:30:59'), ('2', 'manage_users', '管理用户', null, '2014-12-22 02:30:59', '2014-12-22 02:30:59'), ('3', 'manage_system', '管理系统', null, '2015-02-04 09:40:56', '2015-02-04 09:40:59');
COMMIT;

-- ----------------------------
--  Table structure for `yascmf_post`
-- ----------------------------
DROP TABLE IF EXISTS `yascmf_post`;
CREATE TABLE `yascmf_post` (
  `post_id` int(20) NOT NULL,
  `post_title` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `post_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `post_time` int(30) DEFAULT '0',
  `post_pid` int(20) DEFAULT '0',
  `post_src` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `post_url` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`post_id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `yascmf_setting_type` VALUES ('1', 'default', '默认', '0'), ('2', 'system_operation', '系统操作类型', '0'), ('3', 'content_type', '内容类型', '0'), ('4', 'role_type', '角色类型', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yascmf_settings` VALUES ('1', 'default_setting', '默认设置', '1', '1', '999'), ('2', 'system', '系统', '1', '2', '0'), ('3', 'manager', '管理员', '1', '2', '0'), ('4', 'content', '内容', '1', '2', '0'), ('5', 'upload', '上传', '1', '2', '0'), ('6', 'article', '文章', '1', '3', '0'), ('7', 'page', '单页', '1', '3', '0'), ('8', 'fragment', '碎片', '1', '3', '0'), ('9', 'memo', '备忘', '1', '3', '0'), ('10', 'Founder', '创始人', '1', '4', '0'), ('11', 'Admin', '超级管理员', '1', '4', '0'), ('12', 'Editor', '编辑', '1', '4', '0'), ('13', 'Demo', '演示', '1', '4', '0');
COMMIT;
...
CREATE TABLE `yascmf_system_log` (
  ...
  `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '修改更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='系统日志表';

-- ----------------------------
--  Records of `yascmf_system_log`
-- ----------------------------
BEGIN;
INSERT INTO `yascmf_system_log` VALUES ('1', '1', 'manager', 'http://www.zealer.work/auth/login', '管理员：Admin[admin@example.com] 登录系统。', '127.0.0.1', null, '2016-07-21 09:56:01', '2016-07-21 09:56:01');
COMMIT;
...
-- ----------------------------
--  Table structure for `yascmf_title`
-- ----------------------------
DROP TABLE IF EXISTS `yascmf_title`;
CREATE TABLE `yascmf_title` (
  `tit_id` int(10) NOT NULL AUTO_INCREMENT,
  `tit_name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `tit_url` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tit_time` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tit_pid` int(20) DEFAULT '0',
  PRIMARY KEY (`tit_id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
--  Records of `yascmf_title`
-- ----------------------------
BEGIN;
INSERT INTO `yascmf_title` VALUES ('1', '首页', 'http://www.zealer.work', null, '0'), ('2', '视频', 'http://www.zealer.work/media/1', null, '0'), ('3', '手机', 'http://tool.zealer.com/', null, '0'), ('4', '专题', 'http://tool.zealer.com/component/0', null, '0'), ('5', '实验室', 'http://lab.zealer.com/', null, '0'), ('6', '社区', 'http://plus.zealer.com/', null, '1'), ('7', '维修', 'http://fix.zealer.com/', null, '1'), ('8', '联系我们', 'http://www.zealer.com/about?type=contect', null, '1');
COMMIT;
